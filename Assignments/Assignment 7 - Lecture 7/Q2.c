...
void Insert_Node(node_t *head,u32 data,u32 position)
 {
...
printf("To add a node in a certain position enter 3 \n");
...
add_Node(head,val);
	...
	printf("Please enter the number to add in the list \n ");
	scanf("%d",&val);
	printf("Please enter the position to add in the list \n ");
	scanf("%d",&position);
	Insert_Node(head,val,position);
}
else {
